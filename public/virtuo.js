...
const VIRTUO = (() => { //eslint-disable-line
  ...
  const getCar = () => {
    return {
      'name': document.querySelector('#form .js-car-name').value,
      'pricePerDay': document.querySelector('#form .js-price-by-day').value,
      'pricePerKm': document.querySelector('#form .js-price-by-km').value
    };
  };
